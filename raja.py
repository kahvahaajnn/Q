...
def send_attack_finished(message, user_id, target, port, time_duration):
    ...
    bot.send_message(message.chat.id, 
                     f"✅ **𝑨𝑻𝑻𝑨𝑪𝑲 𝑪𝑶𝑴𝑷𝑳𝑬𝑻𝑬!** ✅\n"
                     f"🎯 `{target}:{port}` **𝑫𝑬𝑺𝑻𝑹𝑶𝒀𝑬𝑫!**\n"
                     f"⏳ **𝑫𝑼𝑹𝑨𝑻𝑰𝑶𝑵:** {time_duration}𝙨\n"
                     f"📸 **𝑵𝑶𝑾 𝑺𝑬𝑵𝑫 𝒀𝒐𝒖𝒓 𝒢𝒜𝑀𝐸 𝒮𝒞𝑅𝐸𝐸𝑵𝒮𝐻𝒪𝒯!**\n"
                     f"🔒 **𝒮𝑒𝒸𝓊𝓇𝒾𝓉𝓎 𝒮𝓉𝒶𝓉𝓊𝓈:** 𝑆𝑒𝒸𝓊𝓇𝑒 𝑎𝒏𝒹 𝒞𝑜𝓃𝓉𝒾𝓃𝓊𝑒𝒹\n"
                     f"⚡ **𝒩𝑒𝓉𝓌𝑜𝓇𝒦 𝒮𝓉𝒶𝓉𝓊𝓈:** 𝐶𝑜𝓃𝓃𝑒𝒸𝓉𝑒𝒹 𝑎𝓃𝒹 𝑅𝑒𝒶𝒹𝓎\n"
                     f"🔧 **𝒮𝓎𝓈𝓉𝑒𝓂 𝒮𝓉𝒶𝓉𝓊𝓈:** 𝒪𝓅𝑒𝓃 𝓅𝑜𝓇𝓉 𝒹𝑒𝓉𝑒𝒸𝓉𝑒𝒹 𝒶𝓃𝒹 𝒲𝒾𝒹𝑒 𝒶𝓬𝒸𝑒𝓈𝓈\n"
                     f"🛠️ **𝒞𝑜𝓃𝒹𝒾𝓉𝒾𝑜𝓃:** 𝒜𝓁𝓁 𝓈𝓎𝓈𝓉𝑒𝓂𝓈 𝑜𝓃𝓁𝒾𝓃𝑒 𝒶𝓃𝒹 𝒾𝓈 𝒯𝒶𝓁𝒽𝒾𝒻𝒿𝒶𝓇")
